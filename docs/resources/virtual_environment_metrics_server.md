...
page_title: "/virtual_environment_metrics_server Resource - terraform-provider-proxmox"
subcategory: ""
description: |-
  This resource creates and manages a Proxmox virtual environment metrics server.
---
---
layout: page
