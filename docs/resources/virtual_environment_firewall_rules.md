...
page_title: "virtual_environment_firewall_rules Resource - terraform-provider-proxmox"
subcategory: ""
description: |-
  This resource creates and manages a Proxmox virtual environment firewall rules.
---
---
layout: page
